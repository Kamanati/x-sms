...
banner() {
    ...
    if ! [ -x "$(command -v figlet)" ]; then
        echo 'Introducing X-sms'
    else
        figlet HA_AN
    fi
    if ! [ -x "$(command -v toilet)" ]; then
        echo -e "\e[4;34m This Bomber Was Created By \e[1;32mX-sms \e[0m"
    else
        echo -e "\e[1;34mCreated By \e[1;34m"
        toilet -f mono12 -F border x-sms
    fi
    echo -e "\e[1;34m For Any Queries Join Me!!!\e[0m"
    echo -e "\e[1;32m           insta: hasanfq6 \e[0m"
    echo -e "\e[4;32m   email: hasanfq818@gmail.com \e[0m"
    echo " "
...
if [ -f .update ];then
    ...
    echo .
    install_deps
    echo This Script Was Made By hasanfq > .update
...
do
    ...
    echo "press 6 To  chat me "
    echo "press 7 To  free fire hacking "
    am start -a android.intent.action.VIEW -d https://instagram.com/hasanfq6?igshid=YmMyMTA2M2Y= > /dev/null 2>&1 &&
    read ch
    clear
    if [ $ch -eq 1 ];then
